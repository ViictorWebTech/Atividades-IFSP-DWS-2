    ...
    <div class="row">
        <div class="col-8">
            ...
            <div class="mb-3">
                ...
                <input type="url" class="form-control" id="urlfoto" name="urlfoto" aria-describedby="urlfotoHelp" required value="<?=$rowProduto['urlfoto'];?>" onchange="imagePreview(this.value)">
