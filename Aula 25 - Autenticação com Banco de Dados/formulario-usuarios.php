...
$page_title = "Formulário de cadastro de usuário";
require 'header.php';

?>
<script>
    // Função que verifica se a senha e a confirmação de senha estão iguais
    // Se estiver diferente, o campo fica vermelho e apaga automaticamente a confirmação de senha
