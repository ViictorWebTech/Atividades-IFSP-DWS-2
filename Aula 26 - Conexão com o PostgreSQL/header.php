...
<body>
    ...
    ?>
        <br>
        <h1>Atenção, você esqueceu o require do arquivo <br><strong><code> logica-autenticacao.php</code></strong>!</h1>
    <?php
        die();
    }
    ?>
    ...
    <header class="navbar navbar-dark sticky-top bg-dark flex-md-nowrap p-0 shadow">
        ...
        <div class="navbar-collapse collapse" id="navbarsExample03">
            <ul class="navbar-nav mr-auto px-3 pb-2">
                ...
                <li class="nav-item">
                    <a class="nav-link" href="form-product.php">Formulário</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="list-product.php">Listagem</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="protected-page.php">Página Protegida</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="list-users.php">Usuários</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link btn btn-light btn-sm btn-block font-1 my-1" href="form-login.php">Entrar</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link btn btn-danger btn-sm btn-block font-1 my-1" href="logout.php">Sair</a>
                </li>
            </ul>
        </div>
            ...
            <nav id="sidebarMenu" class="col-md-3 col-lg-2 d-md-block bg-light sidebar collapse">
                <div class="position-sticky mt-3">
                    <ul class="nav flex-column">
                        ...
                        <li class="nav-item">
                            <a class="nav-link" aria-current="page" href="form-product.php">
                                <span data-feather="file-text"></span>
                                Formulário
                            </a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" aria-current="page" href="list-product.php">
                                <span data-feather="list"></span>
                                Listagem
                            </a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" aria-current="page" href="protected-page.php">
                                <span data-feather="lock"></span>
                                Página Protegida
                            </a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" aria-current="page" href="list-users.php">
                                <span data-feather="user"></span>
                                Usuários
                            </a>
                        </li>
